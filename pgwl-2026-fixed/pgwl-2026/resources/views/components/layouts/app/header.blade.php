    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="mr-1.5 space-x-0.5 py-0!">
                ...
                <flux:tooltip content="Halaman Publik" position="bottom">
                    <flux:navbar.item
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group heading="Platform">
                    ...
                    <flux:navlist.item icon="map" href="{{ route('peta') }}" :current="request()->routeIs('peta')" wire:navigate>
                        Peta
                    </flux:navlist.item>
                    <flux:navlist.item icon="table-cells" href="{{ route('tabel') }}" :current="request()->routeIs('tabel')" wire:navigate>
                        Tabel Data
                    </flux:navlist.item>
                </flux:navlist.group>
            </flux:navlist>
